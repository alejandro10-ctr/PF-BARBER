...
export default function SearchBar({setCurrentPage}) {
    ...
    return (
        <div >
            ...
            />
            <button type='text' onClick={(submit) => { handleInputSubmit(submit) }}  className={styles.buttonStyle}><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
