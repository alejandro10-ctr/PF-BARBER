...
export default function Home() {
  ...
  return (
    <div className={styles.background}>
      ...
      <h3 className={styles.subtitle}>  Check our Ecommerce! <svg xmlns="http://www.w3.org/2000/svg" width="26" height="23" fill="white" class="bi bi-chat-heart-fill" viewBox="0 0 16 16">
